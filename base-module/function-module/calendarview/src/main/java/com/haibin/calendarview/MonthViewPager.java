...
public final class MonthViewPager extends ViewPager {
    ...
    private void init() {
        ...
        addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                int height;
                height = position < getCurrentItem() ? (int) ((mPreViewHeight)
                            * (1 - positionOffset) +
                            mCurrentViewHeight
                                    * positionOffset) : (int) ((mCurrentViewHeight)
                            * (1 - positionOffset) +
                            (mNextViewHeight)
                                    * positionOffset);
                ViewGroup.LayoutParams params = getLayoutParams();
    ...
    private void updateMonthViewHeight(int year, int month) {
        ...
        if (month == 1) {
            ...
            mNextViewHeight = month == 12 ? CalendarUtil.getMonthViewHeight(year + 1, 1, mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart()) : CalendarUtil.getMonthViewHeight(year, month + 1, mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart());
        }
    }
