...
public final class PickerHelper {
    ...
    public static void initTimePicker(TimePickerView pvTime) {//Dialog 模式下，在底部弹出
        setStyle(pvTime);
        pvTime.show();
    }
    ...
    public static TimePickerView build(Context context, OnTimeSelectListener onTimeSelectListener, boolean[] bolArray) {
        return init(context, onTimeSelectListener)
                ...
                .setTitleText("")//标题文字
                .setDividerColor(Color.parseColor("#F5F5F5"))//设置分割线颜色
                .setTitleColor(Color.BLACK)//标题文字颜色
                .setSubmitColor(Color.parseColor("#4385F5"))//确定按钮文字颜色
                .setCancelColor(Color.parseColor("#6F7580"))//取消按钮文字颜色
